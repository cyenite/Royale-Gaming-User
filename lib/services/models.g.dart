...
NewGames _$NewGamesFromJson(Map<String, dynamic> json) => NewGames(
      ...
      games: (json['games'] as List<dynamic>?)?.map((e) => Tournaments.fromJson(e as Map<String, dynamic>)).toList() ?? const [],
    );
...
Tournaments _$TournamentsFromJson(Map<String, dynamic> json) => Tournaments(
      ...
      gamePlayTime: json['gamePlayTime'] as String? ?? '0000-00-00 00:00:00.000',
      ...
      joinedPlayers: (json['joinedPlayers'] as List<dynamic>?)?.map((e) => JoinedPlayers.fromJson(e as Map<String, dynamic>)).toList() ?? const [],
      playerResults: (json['playerResults'] as List<dynamic>?)?.map((e) => JoinedPlayers.fromJson(e as Map<String, dynamic>)).toList() ?? const [],
    );
...
JoinedPlayers _$JoinedPlayersFromJson(Map<String, dynamic> json) => JoinedPlayers(
...
Map<String, dynamic> _$JoinedPlayersToJson(JoinedPlayers instance) => <String, dynamic>{
      'uid': instance.uid,
